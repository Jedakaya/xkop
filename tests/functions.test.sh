...
# --- штатные функции OpenWrt и строгий режим --------------------------------
#
# /lib/functions.sh не рассчитан на set -u: он умирает на первой необъявленной
# переменной ("IPKG_INSTROOT: parameter not set"). Через него читаются ВСЕ
# списки из uci — категории, домены, подсети, ссылки, выученное Канарейкой, —
# и его смерть выглядит как пустой список, а не как отказ.
#
# Итог на живом роутере: конфигурация без единого правила, весь трафик
